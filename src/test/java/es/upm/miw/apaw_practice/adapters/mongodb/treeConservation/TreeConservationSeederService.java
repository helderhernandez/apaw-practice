...
import es.upm.miw.apaw_practice.adapters.mongodb.treeConservation.daos.*;
...
@Autowired
    ...
    public void seedDatabase() {
        ...
        InspectionEntity[] inspections = {
                new InspectionEntity(LocalDate.now(),"type1","status1",inspectors[0]),
                new InspectionEntity(LocalDate.now(),"type1","status1",inspectors[0]),
                new InspectionEntity(LocalDate.now(),"type2","status2",inspectors[0]),
                new InspectionEntity(LocalDate.now(),"type1","status2",inspectors[1]),
                new InspectionEntity(LocalDate.now(),"type2","status2",inspectors[1]),
                new InspectionEntity(LocalDate.now(),"type2","status3",inspectors[1]),
                new InspectionEntity(LocalDate.now(),"type1","status3",inspectors[2]),
                new InspectionEntity(LocalDate.now(),"type1","status3",inspectors[2]),
                new InspectionEntity(LocalDate.now(),"type2","status1",inspectors[2])
        };
        ...
        TreeEntity[] trees = {
                ...
                new TreeEntity("specie2","young", Arrays.asList(inspections[6],inspections[7]),List.of(diseases[4],diseases[5])),
                new TreeEntity("specie3","mature", Arrays.asList(inspections[8]),List.of(diseases[5],diseases[0])),
