...
public class SocialNetworkSeederService {
    ...
    public void seedDatabase() {
        ...
        SocialUserEntity[] socialUserEntities = {
                ...
                new SocialUserEntity("Pepe_o", "Bio de Pepe_o", true,
                        Collections.emptyList(), Collections.emptyList()),
                new SocialUserEntity("Francisco26", "Bio de Francisco26", true,
                        Collections.emptyList(), Collections.emptyList()),
        };
        socialListEntities[1].setSocialUserEntities(Arrays.asList(socialUserEntities[2], socialUserEntities[3], socialUserEntities[4]));
